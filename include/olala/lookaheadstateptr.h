 ...
 */
#ifndef OLALA_LOOKAHEADSTATEPTR_H
#define OLALA_LOOKAHEADSTATEPTR_H
...
typedef std::unique_ptr<LookaheadState> LookaheadStatePtr;

} /* -- namespace OLala */

#endif //OLALA_LOOKAHEADSTATEPTR_H
